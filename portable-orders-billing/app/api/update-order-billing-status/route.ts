/**
 * API Route: Update order billing status (and optional billing notes).
 *
 * POST /api/update-order-billing-status
 *
 * Body: {
 *   orderIds: string[],
 *   status: 'billing_pending' | 'billing_successful' | 'billing_failed',
 *   billingNotes?: string
 * }
 *
 * Use this from the Billing list page when changing status for a group of orders.
 * Fix the supabase import to match your app (e.g. @/lib/supabase).
 */
