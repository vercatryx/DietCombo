...
/**
 * Billing list by week: one row per client per week, expandable to show orders and update status.
 * Uses getBillingRequestsByWeek and POST /api/update-order-billing-status.
 */
import { useState, useEffect, useRef } from 'react';
import { useRouter } from 'next/navigation';
import Link from 'next/link';
import { Search, ChevronRight, Download, ChevronDown, ChevronUp, Image } from 'lucide-react';
