...
/**
 * Client billing detail: header with client name, summary cards, billing history table.
 * Expandable rows show order details (Food/Boxes/other). Uses getClient and getBillingHistory.
 */
